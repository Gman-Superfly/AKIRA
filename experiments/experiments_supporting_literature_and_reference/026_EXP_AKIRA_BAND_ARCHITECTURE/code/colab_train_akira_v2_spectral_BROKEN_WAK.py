...
print(f"\nStarting SPECTRAL BELIEF MACHINE V2 training...")
...
best_loss = train_spectral(model, train_loader, eval_loader, total_steps=5000)
...
print(f"SBM v2 (correct impl):   {best_loss:.4f} (ppl {math.exp(best_loss):.2f})")
print("="*60)
